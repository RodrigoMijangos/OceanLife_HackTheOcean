window.addEventListener("load",function(){
    ...
    button.addEventListener("click", function(){
        ...
        var URL = "https://eastus.api.cognitive.microsoft.com/customvision/v3.0/Prediction/f3bfcd31-a17d-46ff-9250-e2d531479bf1/classify/iterations/Iteration3/image";
        ...
        function processRequest(e){
            if(prueba.readyState == 4 && prueba.status == 200){
                ...
                const prob = parseInt(json.predictions[0]['probability'] * 100);
                if(document.getElementById("Especie").textContent != 'Negative' && prob >= 70)
                {
                    btn.disabled = false;
                    document.getElementById("Estatus").textContent = '¡Esta especie se encuentra en peligro!, Realiza tu reporte ahora:';
                }
            }
        }
    },false);
